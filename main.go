...
import (
	...
	"github.com/FloatTech/ZeroBot-Plugin/plugin/dress"         // 女装
	...
	"github.com/FloatTech/ZeroBot-Plugin/plugin/breakrepeat" // 打断复读
...
func init() {
	...
	config.Z = zero.Config{
		NickName:       append([]string{*adana}, "ATRI", "atri", "qwq", "アトリ"),
